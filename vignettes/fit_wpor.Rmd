...
## Defining custom nuisance models
...
To address this, the `wpor` package includes a custom implementation of the `lightgbm` packages. Users interested in creating their own training algorithms can refer the source code for 

* lightgbm_spec
* fit.lightgbm_spec
* predict.lightgbm_fit

and, optionally, 

* add_weights_column.lightgbm_spec
* get_weights_column.lightgbm_spec
* get_y.lightgbm_spec
* update_params.lightgbm_spec

Below, we also include minimal tuning the parameters of lightgbm. 
